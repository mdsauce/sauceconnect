...
do
    DATETIME=$(date +%H-%M-%S)
    LOG_PATH=/tmp/sc-serial-$DATETIME.log
    PID_FILE=/tmp/sc-serial-$DATETIME.pid
    ...
    $SC_PATH/bin/sc -u $SAUCE_USERNAME -k $SAUCE_ACCESS_KEY -i $TUNNEL_NAME -v -d $PID_FILE -l $LOG_PATH --se-port 0 | 
    ...
    do
        ...
        *"Sauce Connect is up, you may start your tests."* )
            ...
            echo $'\xE2\x9C\x94'  "Sauce Connect ${TUNNEL_NAME} started normally"
